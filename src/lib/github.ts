...
export function getDemoUsers(): GitHubUserData[] {
  return [
    // ★ offxahmed — City Owner (center position)
    {
      username: 'offxahmed',
      avatarUrl: 'https://avatars.githubusercontent.com/u/offxahmed',
      ...
      topRepos: [
        { name: 'git-city', stars: 5, language: 'TypeScript', description: '3D GitHub Profile Visualization Platform' },
        { name: 'Kashif-Rugs', stars: 3, language: 'JavaScript', description: 'E-commerce rug store' },
      ],
      contributionCalendar: generateFakeCalendar(1200),
    ...
    // --- Additional famous developers ---
    {
      username: 'getify',
      avatarUrl: 'https://avatars.githubusercontent.com/u/150330',
      ...
      totalCommits: 2000,
      topLanguages: [
        { name: 'JavaScript', count: 90, color: '#f1e05a' },
        { name: 'HTML', count: 15, color: '#e34c26' },
      ],
      topRepos: [
        { name: 'You-Dont-Know-JS', stars: 175000, language: null, description: 'A book series on JavaScript' },
      ],
      contributionCalendar: generateFakeCalendar(2000),
      createdAt: '2009-11-15T00:00:00Z',
    },
    {
      username: 'addyosmani',
      ...
      totalCommits: 2400,
      topLanguages: [
        { name: 'JavaScript', count: 200, color: '#f1e05a' },
        { name: 'HTML', count: 60, color: '#e34c26' },
        { name: 'CSS', count: 40, color: '#563d7c' },
      ],
      topRepos: [
        { name: 'todomvc', stars: 28000, language: 'JavaScript', description: 'Helping you select an MV* framework' },
        { name: 'critical', stars: 10000, language: 'JavaScript', description: 'Extract & inline critical-path CSS' },
      ],
      contributionCalendar: generateFakeCalendar(2400),
      createdAt: '2009-08-10T00:00:00Z',
    },
    {
      username: 'bradtraversy',
      avatarUrl: 'https://avatars.githubusercontent.com/u/5550850',
      ...
      totalCommits: 2200,
      topLanguages: [
        { name: 'JavaScript', count: 120, color: '#f1e05a' },
        { name: 'Python', count: 30, color: '#3572A5' },
        { name: 'HTML', count: 40, color: '#e34c26' },
        { name: 'CSS', count: 30, color: '#563d7c' },
      ],
      topRepos: [
        { name: '50projects50days', stars: 33000, language: 'CSS', description: '50+ mini web projects using HTML, CSS & JS' },
        { name: 'design-resources-for-developers', stars: 55000, language: null, description: 'Curated list of design and UI resources' },
      ],
      contributionCalendar: generateFakeCalendar(2200),
      createdAt: '2013-10-01T00:00:00Z',
    },
    {
      username: 'wesbos',
      avatarUrl: 'https://avatars.githubusercontent.com/u/176013',
      ...
      totalCommits: 1800,
      topLanguages: [
        { name: 'JavaScript', count: 130, color: '#f1e05a' },
        { name: 'CSS', count: 30, color: '#563d7c' },
        { name: 'HTML', count: 25, color: '#e34c26' },
      ],
      topRepos: [
        { name: 'JavaScript30', stars: 27000, language: 'HTML', description: '30 Day Vanilla JS Coding Challenge' },
        { name: 'React-For-Beginners-Starter-Files', stars: 2800, language: 'JavaScript', description: 'Starter Files for React for Beginners' },
      ],
      contributionCalendar: generateFakeCalendar(1800),
      createdAt: '2009-01-10T00:00:00Z',
    },
    {
      username: 'florinpop17',
      avatarUrl: 'https://avatars.githubusercontent.com/u/6692364',
      bio: 'Building 1000 projects in 1000 days',
      name: 'Florin Pop',
      company: null,
      location: 'Romania',
      followers: 11000,
      ...
      totalCommits: 4000,
      topLanguages: [
        { name: 'JavaScript', count: 250, color: '#f1e05a' },
        { name: 'CSS', count: 50, color: '#563d7c' },
        { name: 'HTML', count: 40, color: '#e34c26' },
      ],
      topRepos: [
        { name: 'app-ideas', stars: 75000, language: null, description: 'A Collection of application ideas' },
      ],
      contributionCalendar: generateFakeCalendar(4000),
      createdAt: '2014-02-14T00:00:00Z',
    },
    {
      username: 'fireship-io',
      avatarUrl: 'https://avatars.githubusercontent.com/u/44869088',
      bio: 'Build and ship your app faster',
      name: 'Fireship',
      company: 'Fireship.io',
      location: null,
      followers: 9000,
      ...
      totalCommits: 1600,
      topLanguages: [
        { name: 'TypeScript', count: 35, color: '#3178c6' },
        { name: 'JavaScript', count: 15, color: '#f1e05a' },
        { name: 'Dart', count: 5, color: '#00B4AB' },
      ],
      topRepos: [
        { name: 'fireship.io', stars: 3000, language: 'TypeScript', description: 'Build and ship creative things' },
      ],
      contributionCalendar: generateFakeCalendar(1600),
      createdAt: '2018-11-01T00:00:00Z',
    },
    {
      username: 'mojombo',
      ...
      totalCommits: 1400,
      topLanguages: [
        { name: 'Ruby', count: 30, color: '#701516' },
        { name: 'JavaScript', count: 10, color: '#f1e05a' },
        { name: 'Shell', count: 5, color: '#89e051' },
      ],
      topRepos: [
        { name: 'jekyll', stars: 48000, language: 'Ruby', description: 'A blog-aware static site generator in Ruby' },
      ],
      contributionCalendar: generateFakeCalendar(1400),
      createdAt: '2007-10-20T00:00:00Z',
    },
    {
      username: 'developedbyed',
      avatarUrl: 'https://avatars.githubusercontent.com/u/33045755',
      ...
      totalCommits: 900,
      topLanguages: [
        { name: 'JavaScript', count: 40, color: '#f1e05a' },
        { name: 'CSS', count: 15, color: '#563d7c' },
        { name: 'TypeScript', count: 10, color: '#3178c6' },
      ],
      topRepos: [
        { name: 'react-admin-dashboard', stars: 3000, language: 'JavaScript', description: 'React Admin Dashboard Tutorial' },
      ],
      contributionCalendar: generateFakeCalendar(900),
      createdAt: '2017-10-10T00:00:00Z',
    },
    {
      username: 'antfu',
      avatarUrl: 'https://avatars.githubusercontent.com/u/11247099',
      bio: 'A fanatical open sourceror, Vue & Vite core team',
      name: 'Anthony Fu',
      company: 'NuxtLabs',
      ...
      totalCommits: 8000,
      topLanguages: [
        { name: 'TypeScript', count: 350, color: '#3178c6' },
        { name: 'Vue', count: 80, color: '#41b883' },
        { name: 'JavaScript', count: 40, color: '#f1e05a' },
      ],
      topRepos: [
        { name: 'slidev', stars: 31000, language: 'TypeScript', description: 'Presentation Slides for Developers' },
        { name: 'vitesse', stars: 8600, language: 'TypeScript', description: 'Opinionated Vite + Vue Starter Template' },
      ],
      contributionCalendar: generateFakeCalendar(8000),
      createdAt: '2015-03-10T00:00:00Z',
    },
    {
      username: 'shadcn',
      avatarUrl: 'https://avatars.githubusercontent.com/u/124599',
      bio: 'Building shadcn/ui',
      name: 'shadcn',
      company: 'Vercel',
      location: null,
      followers: 22000,
      ...
      topRepos: [
        { name: 'ui', stars: 65000, language: 'TypeScript', description: 'Beautifully designed components built with Radix UI and Tailwind CSS' },
        { name: 'taxonomy', stars: 17000, language: 'TypeScript', description: 'An open source application built with Next.js 13' },
      ],
      contributionCalendar: generateFakeCalendar(1800),
      createdAt: '2009-09-15T00:00:00Z',
    },
  ];
}
